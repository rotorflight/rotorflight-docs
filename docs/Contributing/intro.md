...
## Flight testing/Crashing[​](#flight-testingcrashing "Direct link to Flight testing/Crashing")

Rotorflight gets better due to beta-testing code. Lots of things have to be tested and are constantly changing. Some things are not working yet. Sometimes bugs are creeping into the code.
