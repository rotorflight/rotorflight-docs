...
import theCouplingEffect from "./img/the-coupling-effect.png";
import diskBodyModel from "./img/Disk_Body_Model.jpg";
...
<img src={theCouplingEffect} alt="The Coupling Effect" style={{ maxWidth: '100%' , borderRadius: '10px' }} />\
...
<img src={diskBodyModel} alt="Disk Body Model" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
