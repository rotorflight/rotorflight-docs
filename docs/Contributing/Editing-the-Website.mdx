...
<img src={edit1} alt="Editing" style={{ maxWidth: '100%' , borderRadius: '10px' }} />

In the top right hand corner of the page click on Edit

<img src={edit2} alt="Editing" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
...
<img src={edit3} alt="Editing" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
...
<img src={edit4} alt="Editing" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
