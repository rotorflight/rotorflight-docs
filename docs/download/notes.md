...
* [**Flash new version**](../setup/flashing-the-firmware.md) with ***Full Chip Erase***
* [**Restore your settings**](../setup/backup-and-restore.md#loadrestore-config) from the backup file
...
* [Castle ESC Telemetry](../setup/esc-telemetry.md#castle-esc-telemetry)
* JR DMSS XBUS Protocol added
* [BlackBox Extra stuff](../configurator/tabs/blackbox.md#blackbox-configuration)
* Disarm grace period
* Initial erase
* Rolling erase
* [ESC Voltage and Current scaling](../setup/esc-telemetry.md#calibrate-telemetry-values)
* [Positive and Negative collective tilt](../configurator/tabs/mixer.md#positive-and-negative-collective-tilt-correction)
* [Inertia Precomp](../configurator/tabs/profiles.md#inertia-precomp-gain)
* [Mixer Passthrough](../setup/setup-mixer.md#mixer-override)
* Setpoint Boost
