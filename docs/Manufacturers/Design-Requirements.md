...
## Betaflight Guidelines[​](#betaflight-guidelines "Direct link to Betaflight Guidelines")

Rotorflight is based on Betaflight, and thus has the same basic requirements for the hardware.

Please read the Design Guidelines for [Betaflight](https://github.com/betaflight/betaflight/blob/4.4.0-RC5/docs/Manufacturer%20Design%20Guidelines.md) first.

## Rotorflight Design[​](#rotorflight-design "Direct link to Rotorflight Design")
