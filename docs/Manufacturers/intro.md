...
We have documented some flight controller [Design Requirements](/docs/Manufacturers/Design-Requirements.md). Also there are several pin and MCU specific [Reference Designs](/docs/Manufacturers/Reference-Design.md). These are specified to optimise resources and provide a consistent starting point.
