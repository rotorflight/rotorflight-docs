...
We have documented some flight controller [Design Requirements](Design-Requirements.mdx). Also there are several pin and MCU specific [Reference Designs](Reference-Design.mdx). These are specified to optimize resources and provide a consistent starting point.
