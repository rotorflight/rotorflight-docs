...
import PowerMain from '../img/power-main.png';
import PowerState from '../img/power-state.png';
import PowerBattery from '../img/power-battery.png';
import PowerVoltage from '../img/power-voltage.png';
import PowerFuel from '../img/power-fuel.png';
...
<div style={{ textAlign: 'center' }}>
  <img src={PowerState} style={{ width: '100%', borderRadius: '10px' }} />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img src={PowerBattery} style={{ width: '100%', borderRadius: '10px' }} />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img src={PowerFuel} style={{ width: '100%', borderRadius: '10px' }} />
</div>
...
See the [SmartFuel setup guide](../../setup/smartfuel.mdx) for full configuration and tuning instructions.

## Voltage Meters

<div style={{ textAlign: 'center' }}>
  <img src={PowerVoltage} style={{ width: '100%', borderRadius: '10px' }} />
</div>
