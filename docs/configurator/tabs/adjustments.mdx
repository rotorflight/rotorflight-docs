...
import adjustmentsCuttoff from "../img/adjustments-cuttoff.png";
...
<img src={adjustmentsMain} alt="Adjustments Tab" style={{ maxWidth: '100%' }} />
...
**PID**\
<img src={adjustmentsPid} alt="Profiles" style={{ maxWidth: '100%' }} />

**Gyro cutoffs**\
<img src={adjustmentsCuttoff} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
