...
import adjustmentsMain from "../img/adjustments-main.png";
import adjustmentsProfiles from "../img/adjustments-profiles.png";
import adjustmentsRates from "../img/adjustments-rates.png";
import adjustmentsPid from "../img/adjustments-pid.png";
import adjustmentsCutoff from "../img/adjustments-cutoff.png";
import adjustmentsDterm from "../img/adjustments-dterm.png";
import adjustmentsRescue from "../img/adjustments-rescue.png";
import adjustmentsLevel from "../img/adjustments-level.png";
import adjustmentsGov from "../img/adjustments-gov.png";
import adjustmentsBoost from "../img/adjustments-boost.png";
import adjustmentsOffset from "../img/adjustments-offset.png";
import adjustmentsCoupling from "../img/adjustments-coupling.png";
import adjustmentsTrim from "../img/adjustments-trim.png";
...
<img src={adjustmentsMain} alt="Adjustments Tab" style={{ maxWidth: '100%', borderRadius: '10px' }} />
...
<img src={adjustmentsProfiles} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

**Rates**\\

<img src={adjustmentsRates} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

**PID**\\

<img src={adjustmentsPid} alt="Profiles" style={{ maxWidth: '100%', borderRadius: '10px' }} />

**Gyro cutoffs**\\

<img src={adjustmentsCutoff} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

**Dterm cutoffs**\\

<img src={adjustmentsDterm} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

**Rescue**\\

<img src={adjustmentsRescue} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

**Leveling**\\

<img src={adjustmentsLevel} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

**Governor**\\

<img src={adjustmentsGov} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

**Boost gains**\\

<img src={adjustmentsBoost} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

**Offset gains**\\

<img src={adjustmentsOffset} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

**Cross-coupling**\\

<img src={adjustmentsCoupling} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

**Accelerometer trims**\\

<img src={adjustmentsTrim} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
