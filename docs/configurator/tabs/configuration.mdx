...
sidebar_position: 30
---
import configPrsnl from "../img/config-prsnl.png";
import configSysConf from "../img/config-sys-conf.png";
import configFeatures from "../img/config-features.png";
import configSerial from "../img/config-serial.png";
import configSensAlign from "../img/config-sens-align.png";
import configAccelTrim from "../img/config-accel-trim.png";
...
<img src={configPrsnl} alt="Configuration Tab" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

## System Configuration

<img src={configSysConf} alt="Configuration Tab" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={configFeatures} alt="Configuration Tab" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={configSerial} alt="Configuration Tab" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={configSensAlign} alt="Configuration Tab" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={configAccelTrim} alt="Configuration Tab" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
