...
import mixerMainRotorSettings from "../img/mixer-main-rotor-settings.png";
import mixerSwashplateLinkTrims from "../img/mixer-swashplate-link-trims.png";
import mixerMainRotorGeometry from "../img/mixer-main-rotor-geometry.png";
import mixerTailRotorSettings from "../img/mixer-tail-rotor-settings.png";
...
:::note
Before proceeding with setting up the mixer, make sure that [gyro sensor alignment](./configuration.mdx#board-and-sensor-alignment) is correct.
:::
...
<img src={mixerMainRotorSettings} alt="Mixer Tab" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={mixerSwashplateLinkTrims} alt="Mixer Tab" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={mixerMainRotorGeometry} alt="Mixer Tab" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={mixerTailRotorSettings} alt="Mixer Tab" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
