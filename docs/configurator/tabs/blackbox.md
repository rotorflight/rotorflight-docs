...
* An external logging device: [OpenLager](../../setup/openlager.mdx). These devices write the log to a micro SD card.
...
* **Serial Port**: Log to an external logging device (eg. [OpenLager](../../setup/openlager.mdx)).
