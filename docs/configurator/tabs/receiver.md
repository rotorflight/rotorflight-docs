...
* It is preferable that a telemetry capable protocol be used with the [Rotorflight LUA scripts](../../setup/radio-setup/radio-setup-edgetx/edgetx-lua-scripts.md) to perform tuning using you radio.
...
!!! tip
    For ELRS receivers, follow the [ELRS Custom Telemetry](../../setup/elrs-custom-telemetry.md) page for how to setup. This is new for Rotorflight 2.1 and ELRS Reuse is no longer available.
