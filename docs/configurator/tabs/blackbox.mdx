...
import blackboxMain from "../img/blackbox-main.png";
import blackboxConfig from "../img/blackbox-config.png";
import blackboxOptions from "../img/blackbox-options.png";
import blackboxSave from "../img/blackbox-save.png";
import blackboxMass from "../img/blackbox-mass.png";
...
<img src={blackboxMain} alt="Blackbox Tab" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

## Blackbox Configuration

<img src={blackboxConfig} alt="Blackbox Tab" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
* **Serial Port**: Log to an external logging device (e.g. [OpenLager](../../setup/openlager.mdx)).
...
* **No Logging**: Disable Logging.
* **Normal**: Start logging when both [**ARM**](../../setup/arming.mdx) and [**BLACKBOX**](./modes.mdx#blackbox) switches are active.
* **Armed**: Start logging when [**ARM**](../../setup/arming.mdx) switch is active.
* **Switch**: Start logging when [**BLACKBOX**](./modes.mdx#blackbox) switch is active.
...
<img src={blackboxOptions} alt="Blackbox Tab" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={blackboxSave} alt="Blackbox Tab" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={blackboxMass} alt="Blackbox Tab" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
