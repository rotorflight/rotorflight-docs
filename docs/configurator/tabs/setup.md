...
## Calibrate Magnetometer[​](#calibrate-magnetometer "Direct link to Calibrate Magnetometer")
...
## Reset Settings[​](#reset-settings "Direct link to Reset Settings")

Reset Flight Controller to target default parameters.

## Bootloader/DFU[​](#bootloaderdfu "Direct link to Bootloader/DFU")
...
## System Reboot[​](#system-reboot "Direct link to System Reboot")
