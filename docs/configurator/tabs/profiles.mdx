...
import profilesPidControllerGains from "../img/profiles-pid-controller-gains.png";
import profilesPidControllerSettings from "../img/profiles-pid-controller-settings.png";
import profilesOffsetLimit from "../img/profiles-offset-limit.png";
import profilesMainRotorSettings from "../img/profiles-main-rotor-settings.png";
import profilesTailRotorSettings from "../img/profiles-tail-rotor-settings.png";
import profilesPidControllerBandwidth from "../img/profiles-pid-controller-bandwidth.png";
import profilesAutoLevelingSettings from "../img/profiles-auto-leveling-settings.png";
import profilesRescue from "../img/profiles-rescue.png";
...
<img src={profilesPidControllerGains} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
This provides a rapid short term increase in your command. This parameter is used in conjunction with the time [B-Cutoff](./profiles.mdx#b-term-cutoff).

## Advanced Settings

### PID Controller Settings

<img src={profilesPidControllerSettings} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={profilesOffsetLimit} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={profilesMainRotorSettings} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={profilesTailRotorSettings} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={profilesPidControllerBandwidth} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
It is safe to start with the same cutoffs as used with D. Usually in the range of 10..20. This is used in conjunction with [Boost](./profiles.mdx#boost) or [B-gain](./profiles.mdx#boost)

## Auto Leveling Settings

<img src={profilesAutoLevelingSettings} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={profilesRescue} alt="Profiles" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
