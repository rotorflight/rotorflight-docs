...
![Profiles](/assets/images/profiles-pid-controller-gains-e48a5d1612d63c3bc6b6755945b26e29.png)
...
![Profiles](/assets/images/profiles-pid-controller-settings-5ffb300380e6f943d4cd109012ec02a6.png)
...
![Profiles](/assets/images/profiles-main-rotor-settings-7908365250b88ab370fbec2adc8bc412.png)
...
![Profiles](/assets/images/profiles-tail-rotor-settings-8340df6c7c4112b40becf71bbcd3699e.png)
...
#### Yaw Precomp cuttoff[​](#yaw-precomp-cuttoff "Direct link to Yaw Precomp cuttoff")
...
![Profiles](/assets/images/profiles-pid-controller-bandwidth-ebaf3e547102c6beeca38ffe11f489bf.png)
...
This is controlling how "quick" or "twitchy" the boost is. This works exactly the same as D-cutoff, but on setpoint. It is safe to start with the same cutoffs as used with D. Usually in the range of 10..20. This is used in conjunction with [Boost](/docs/configurator/tabs/profiles.md#boost) or [B-gain](/docs/configurator/tabs/profiles.md#boost)

## Auto Leveling Settings[​](#auto-leveling-settings "Direct link to Auto Leveling Settings")

![Profiles](/assets/images/profiles-auto-leveling-settings-224b7eb5de21a1f3d16d5464aed9b162.png)
