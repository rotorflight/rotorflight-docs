...
sidebar_position: 80
---
import motorMain from "../img/motor-main.png";
import motorProtocol from "../img/motor-protocol.png";
import motorTelem from "../img/motor-telem.png";
import motorPwm from "../img/motor-pwm.png";
import motorDshot from "../img/motor-dshot.png";
import motorGearRatio from "../img/motor-gear-ratio.png";
import motorPoleCount1 from "../img/motor-pole-count-1.png";
import motorPoleCount2 from "../img/motor-pole-count-2.png";
import motor6 from "../img/motor-6.png";
...
<img src={motorMain} alt="Motor and ESC" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

### ESC Throttle Protocol

Set the ESC protocol required for your ESC under *ESC/Motor protocol*. Usually this would be *PWM* or *DSHOT 300*.

<img src={motorProtocol} alt="Motor and ESC" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

### ESC Telemetry Protocol

Set the ESC [*Telemetry*](../../setup/esc-telemetry.mdx) protocol if your esc supports it.

<img src={motorTelem} alt="Motor and ESC" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={motorPwm} alt="Motor and ESC" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={motorDshot} alt="Motor and ESC" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={motorGearRatio} alt="Motor and ESC" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={motorPoleCount1} alt="Motor and ESC" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

<img src={motorPoleCount2} alt="Motor and ESC" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={motor6} alt="Motor and ESC" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
