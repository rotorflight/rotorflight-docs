...
:::note
This is the official Rotorflight tune for the Goosky S2 Max. The S2 Max and S2 Ultra use different tunes—select the correct one for your model. This tune requires updated AM32 ESC firmware, so update your ESC before applying.
:::
