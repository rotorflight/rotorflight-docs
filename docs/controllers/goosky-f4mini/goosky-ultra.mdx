...
This section is for the Rotorflight Official tune for the Goosky S2 Ultra which is supplied with the Goosky F4 Mini FC.
...
# Update Procedure for the S2 Ultra

:::note
This is the official Rotorflight tune for the Goosky S2 Ultra. It is different to the S2 Max so please choose the tune to suit your helicopter. The tune is specific to the later versions of AM32 ESC firmware so please make sure you update ESC firmware as part of setting this tune.
:::

The F4-mini is a plug-and-play replacement for the stock S2 Max flight controller. Team Rotorflight has tuned the F4-mini for the S2 Ultra. However, before you can apply this tune, you'll need to update the firmware on the F4-mini and the stock Goosky ESC. Here's how you can update.
...
Windows needs the right drivers for flashing Rotorflight. If you haven't flashed Rotorflight before or if the above procedure fails, refer to the instructions under [**Flashing the Firmware**](/docs/setup/flashing-the-firmware).
:::

## 2. Configure the F4-mini for the S2 Ultra

The Rotorflight team has created two tunes for the S2 Ultra.
RPMs for profile 1/2/3: 4400/5100/5500.

* S2 Ultra [Configuration Diff](../configs/RTFL-backup-diff-S2U-AM32v219-20251217-Preset.txt)
* S2 Ultra [Configuration Dump](../configs/RTFL-backup-dump-S2U-AM32v219-20251217-110951.txt)
...
1. Download [`S2-ultra-main-esc-config-12-16.bin`](../configs/S2-ultra-main-esc-config-12-16.bin)
2. Click on *Apply config*
3. Click *Choose file* and select the file `S2-ultra-main-esc-config-12-16.bin` that you just downloaded
4. Only select ESC 1
5. Click *Apply*

Now configure the tail ESC.

1. Download [`S2-ultra-tail-esc-config-12-16.bin`](../configs/S2-ultra-tail-esc-config-12-16.bin)
2. Click on *Apply config*
3. Click *Choose file* and select the file `S2-ultra-tail-esc-config-12-16.bin`
4. Only select ESC 2
5. Click *Apply*
6. Click *Disconnect*
7. Power down the S2
