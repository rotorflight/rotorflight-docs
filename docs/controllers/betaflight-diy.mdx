...
sidebar_position: 80
---
import m1DarwinfpvRight from "./img/m1-darwinfpv-right.jpg";
import m1DarwinfpvLeft from "./img/m1-darwinfpv-left.jpg";
import m1Darwinfpv15aPins from "./img/m1-darwinfpv-15a-pins.png";
import trex150xMpu6500 from "./img/trex-150x-mpu6500.jpg";
...
<img src={m1DarwinfpvRight} alt="M1" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={m1DarwinfpvLeft} alt="M1" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={m1Darwinfpv15aPins} alt="M1" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={trex150xMpu6500} alt="T-REX 150X" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
