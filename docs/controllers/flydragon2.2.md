...
![Flydragon v2.2](/assets/images/flydragon2-2-e8de7bc86901aa8597ec7be63deebf49.png)
...
![Flydragon V2.2 Target](/assets/images/fd-target-77c9f45ba05d16ad6928c274094dcf60.png)
...
![Flydragon V2.2 Target](/assets/images/fd-motorised-a5c6b50fdb28ff6b04bd45f79ca4deb5.png)

### Wiring[​](#wiring "Direct link to Wiring")

![Wiring Diagram v2.2](/assets/images/wiring-diagram-v2-59bd2947b0d8a4230d387211d5e9e8f2.png)
...
![Save](/assets/images/fd-uarts-f3356456985d36f42573eb5b2a2e0f8b.png)
...
![disable](/assets/images/disable-55f0e7ed8a7757cc7b2a5663153bc422.png)

* Command to **ENABLE** the receiver:
  <br />
  `set pinio_config = 129,1,1,1`

![Enable](/assets/images/enable-c045a227745f04ea36605ea6203acf3c.png)

## Manuals[​](#manuals "Direct link to Manuals")

[Flydragon V2.2 Flight Controller Manual](/assets/files/FlyDragonF722_v2.2_FBL_Specfications-a045a52879ba2029bf54fbf1df4126e6.pdf)<br />[Flydragon V2 Flight Controller Manual](/assets/files/FlyDragonF722_v2_FBL_Specfications-a50f529de8b1256997df1f7a31a5d2bb.pdf)<br />[Flydragon V2 internal ELRS Manual](/assets/files/FlyDragonF722_v2_ELRS_Receiver_Manual-2965cd18738e4b3158659a527723e436.pdf)
