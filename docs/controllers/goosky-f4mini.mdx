...
![Goosky F4MINI](./img/ggoosky-f4mini.png)

:::info[Specifications]
### Goosky F4MINI Flight Controller
...
The first batch of F4MINI flight controllers and ESCs have outdated firmware and settings that do not make optimal use of the hardware. Here's how you can update.

## 1. Update the F4MINI Firmware
...
## 2. Configure the F4MINI for the S2 MAX

The Rotorflight team have created two tunes for the S2 MAX.
...
:::warning
Do not use these configurations if you haven't flashed the F4MINI as described above. The configuration expects certain default values which are only available after flashing the GOOSKY\_F4MINI board.
:::
...
3. Connect the F4MINI using USB
4. Make sure *Rotorflight Configurator* isn't connected to the F4MINI. If it is, press *Disconnect*.
...
10. Click *Choose file* and select the `AM32_GOOSKY_3S_F421_2.19.hex` file you downloadeded
11. Click *Start flash*
