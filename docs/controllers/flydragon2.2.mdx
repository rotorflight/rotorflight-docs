...
sidebar_position: 30
---
import flydragon22 from "./img/flydragon2-2.png";
import fdTarget from "./img/fd-target.png";
import fdMotorised from "./img/fd-motorised.png";
import wiringDiagramV2 from "./img/wiring-diagram-v2.png";
import fdUarts from "./img/fd-uarts.png";
import disable from "./img/disable.png";
import enable from "./img/enable.png";

# Flydragon V2.2

<img src={flydragon22} alt="Flydragon v2.2" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={fdTarget} alt="Flydragon V2.2 Target" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={fdMotorised} alt="Flydragon V2.2 Target" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

### Wiring

<img src={wiringDiagramV2} alt="Wiring Diagram v2.2" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={fdUarts} alt="Save" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={disable} alt="disable" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

* Command to **ENABLE** the receiver:\
  `set pinio_config = 129,1,1,1`

<img src={enable} alt="Enable" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
