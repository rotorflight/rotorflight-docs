...
8. If you receive an error similar to this, when trying to read the values, please ensure the main S2 Battery is also connected.
![Goosky F4-mini](../img/Am32_no_battery_error.jpg)
9. Click *Flash firmware*
10. Go to the *Local* tab
11. Select *Ignore current mcu layout* if you flash the ESC for the first time
12. Click *Choose file* and select the `AM32_GOOSKY_3S_F421_2.19.hex` file you downloaded
13. Click *Start flash* and wait till it's done
