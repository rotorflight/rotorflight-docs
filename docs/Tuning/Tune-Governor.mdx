...
<img src={govFGainTooLow} alt="f-gain too low" style={{ maxWidth: '100%' }} />

If the F-gain is too high, the headspeed will be temporarily too high.

<img src={govFGainTooHigh} alt="f-gain too high" style={{ maxWidth: '100%' }} />
...
<img src={govIGainTooHigh} alt="i-gain too high" style={{ maxWidth: '100%' }} />
...
<img src={govPGainTooHigh} alt="p-gain too high" style={{ maxWidth: '100%' }} />
...
<img src={govResultGraph} alt="Result" style={{ maxWidth: '100%' }} />

And these are the gain values found for this heli:

<img src={govResult} alt="Result" style={{ maxWidth: '100%' }} />
