...
import govFGainTooLow from "./img/gov-f-gain-too-low.png";
import govFGainTooHigh from "./img/gov-f-gain-too-high.png";
import govIGainTooHigh from "./img/gov-i-gain-too-high.png";
import govPGainTooHigh from "./img/gov-p-gain-too-high.png";
import govResultGraph from "./img/gov-result-graph.png";
import govResult from "./img/gov-result.png";
...
<img src={govFGainTooLow} alt="f-gain too low" style={{ maxWidth: '100%' , borderRadius: '10px' }} />

If the F-gain is too high, the headspeed will be temporarily too high.

<img src={govFGainTooHigh} alt="f-gain too high" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
...
<img src={govIGainTooHigh} alt="i-gain too high" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
...
<img src={govPGainTooHigh} alt="p-gain too high" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
...
<img src={govResultGraph} alt="Result" style={{ maxWidth: '100%' , borderRadius: '10px' }} />

And these are the gain values found for this heli:

<img src={govResult} alt="Result" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
