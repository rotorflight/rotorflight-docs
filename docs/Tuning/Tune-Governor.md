...
If using the governor you must first enable the [RPM Measurement](/docs/setup/rpm-measurement.md) and configure the [Governor](/docs/setup/governor.md)
