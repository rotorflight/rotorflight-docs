...
!!! note
    If using the governor you must first enable the [RPM Measurement](../setup/rpm-measurement.md) and configure the [Governor](../setup/governor.md)
