...
These tuning parameters are located on the Profile tab in the [Configurator](../configurator/tabs/profiles.md) and could also be changed via the [LUA Scripts](../setup/radio-setup/radio-setup-edgetx/edgetx-lua-scripts.mdx) or [Adjustments](../configurator/tabs/adjustments.md)
