...
These tuning parameters are located on the Profile tab in the [Configurator](/docs/configurator/tabs/profiles.md) and could also be changed via the [LUA Scripts](/docs/setup/radio-setup/radio-setup-edgetx/edgetx-lua-scripts.md) or [Adjustments](/docs/configurator/tabs/adjustments.md)
...
* Average: Do some flips with sudden stops, try going fast and tapping the stick, do some tick-tocks
