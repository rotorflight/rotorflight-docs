...
import firstFlight1 from "./img/First_flight_1.png";
import firstFlight2 from "./img/First_flight_2.png";
...
<img src={firstFlight1} alt="First Flight" style={{ maxWidth: '100%' , borderRadius: '10px' }} />

### Filtered Gyro:

<img src={firstFlight2} alt="First Flight" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
