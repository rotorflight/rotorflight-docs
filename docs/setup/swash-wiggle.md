...
<video src="./img/arming-ready.mp4" controls playsinline muted width="85%"></video>
...
<video src="./img/arming-fail.mp4" controls playsinline muted width="85%"></video>

## FC Fatal error

The following [**Arm disable flags**](arming.md#disable-flags-description) will trigger a FC fatal error.\
It can be enabled or disabled from the cli:\
