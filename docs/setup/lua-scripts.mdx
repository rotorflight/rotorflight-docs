...
<Tabs groupId="operating-systems">
  ...
  <TabItem value="EdgeTX" label="EdgeTX" attributes={{className: tabStyles.tab}}>
    ...
    Now you can change the values of your PIDs. 
    ...
    On the *Battery* Page you can define up to 6 battery profiles for your heli. These settings are stored on the flight controller of the heli, so each heli can have it's own battery profiles. 
    
    You can also specify the pack you're going to use for the next flight on this page, so the battery capacity sensor will work correctly.
