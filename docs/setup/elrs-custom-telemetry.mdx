...
<Tabs groupId="operating-systems">
  ...
  <TabItem value="EdgeTX" label="EdgeTX" attributes={{className: tabStyles.tab}}>
    ...
    Set ‘Telemetry Rate’ to match the ‘Packet Rate’ you’ve set for ELRS (500 in the example below). Then set ‘Telemetry Ratio’ to match the ‘Telem Ratio’ you’ve set in ELRS (4 in the example below). The screenshot below is from ExpressLRS Lua script’s main screen
