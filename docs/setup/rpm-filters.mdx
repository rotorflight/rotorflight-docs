...
import rpmFiltersMissing from "./img/rpm-filters-missing.png";
import rpmFiltersAdded from "./img/rpm-filters-added.png";
...
<img src={rpmFiltersMissing} alt="Missing filters" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
...
<img src={rpmFiltersAdded} alt="Added filters" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
