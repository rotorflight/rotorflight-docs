...
![Mixer Tab](/rotorflight-docs/assets/images/mixer-override-7255eb04a5b9eaffcb918f4d20cbb6dc.png)
...
* If the Blade angle is different from the Override angle, increase or decrease [**Collective Calibration %**](/rotorflight-docs/docs/configurator/tabs/mixer.md#cyclic-and-collective-calibration) until the bade angle matches.
...
* Increase or decrease the [**Cyclic Calibration %**](/rotorflight-docs/docs/configurator/tabs/mixer.md#cyclic-and-collective-calibration)
...
* Set mixer yaw override to 22deg CW/CCW, adjust [**Yaw Calibration %**](/rotorflight-docs/docs/configurator/tabs/mixer.md#tail-rotor-settings) until you have around 45deg both ways.
  <br />
  **Note** 22 is close enough to 1/2 of 45 deg.
* Set mixer yaw override to 60deg CW/CCW, adjust [**CW / CCW blade angle limits**](/rotorflight-docs/docs/configurator/tabs/mixer.md#tail-rotor-settings) to the maximum number that does not causing binding.
