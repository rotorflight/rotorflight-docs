...
import openLagerSlideInFix from "./img/OpenLager-slide-in-fix.png";
import openlagerSerialPort from "./img/openlager-serial-port.png";
...
<img src={openLagerSlideInFix} alt="OpenLager" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
...
<img src={openlagerSerialPort} alt="OpenLager port setup" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
