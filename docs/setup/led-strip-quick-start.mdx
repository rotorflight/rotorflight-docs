...
import ledstripWiring from "./img/ledstrip-wiring.jpg";
import ledstripGrid from "./img/ledstrip-grid.png";
import ledstripAdjustments from "./img/ledstrip-adjustments.png";
import ledstripC189 from "./img/ledstrip-c189.jpg";
import ledstripPicobus from "./img/ledstrip-picobus.jpg";
...
<img src={ledstripWiring} alt="Wiring" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
...
<img src={ledstripGrid} alt="LED Profile Adjustments" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
...
<img src={ledstripAdjustments} alt="LED Profile Adjustments" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
...
<img src={ledstripC189} alt="C189 PicoBlade Bus" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
...
<img src={ledstripPicobus} alt="Building a PicoBlade Bus" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
