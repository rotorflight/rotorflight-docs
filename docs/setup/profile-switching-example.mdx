...
import changeProfiles1 from "./img/Change_Profiles_1.png";
import changeProfiles2 from "./img/Change_Profiles_2.png";
import changeProfProfSwExample from "./img/change-prof-prof-sw-example.png";
import changeProfiles4 from "./img/Change_Profiles_4.png";
...
<img src={changeProfiles1} alt="Change Profiles" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
...
<img src={changeProfiles2} alt="Change Profiles" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
...
<img src={changeProfProfSwExample} alt="Change Profiles" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
...
<img src={changeProfiles4} alt="Change Profiles" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
