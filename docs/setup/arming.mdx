...
**1.** Open the [Modes tab](../configurator/tabs/modes.mdx)\
...
|   'LOAD'            | System load is too high. This may happen with some low spec boards. Reduce the [PID loop frequency](../configurator/tabs/configuration.mdx#system-configuration) and/or number of filters|
