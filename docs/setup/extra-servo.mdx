...
<img src={remappingServo1} alt="Adding Servo" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
...
<img src={remappingServoTimer} alt="Adding Servo" style={{ maxWidth: '100%' , borderRadius: '10px' }} />

**Step 3:** In the 'Advanced' section assign your AUX channel to servo 5 and then select and copy the mixer config displayed.

<img src={remappingServoMixer} alt="Adding Servo" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
...
<img src={remappingServoCli} alt="Adding Servo" style={{ maxWidth: '100%' , borderRadius: '10px' }} />
