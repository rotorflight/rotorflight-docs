...
<Tabs groupId="RPM-measurement">
  <TabItem value="RPM Sensor" label="RPM Sensor" attributes={{className: tabStyles.tab}}>
    ...
    Then the frequency sensor can be turned ON with the feature flag located on the [***Motors***](../configurator/tabs/motors.mdx#pwm-protocol) tab.

    ![frequency\_2](./img/motors-rpm.png)
  </TabItem>
