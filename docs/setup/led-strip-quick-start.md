...
## Introduction to LED strips[​](#introduction-to-led-strips "Direct link to Introduction to LED strips")
...
[YouTube video player](https://www.youtube.com/embed/GB6hGU9MKpI)
...
## Create a LED\_STRIP resource[​](#create-a-led_strip-resource "Direct link to Create a LED_STRIP resource")
...
## Testing hardware[​](#testing-hardware "Direct link to Testing hardware")
...
### Define the 3 LEDs[​](#define-the-3-leds "Direct link to Define the 3 LEDs")
...
### Create the red anti-collision light[​](#create-the-red-anti-collision-light "Direct link to Create the red anti-collision light")
...
### Create the white landing light[​](#create-the-white-landing-light "Direct link to Create the white landing light")
...
[YouTube video player](https://www.youtube.com/embed/72LsrcEJEK0)

## Molex PicoBlade bus[​](#molex-picoblade-bus "Direct link to Molex PicoBlade bus")
...
### Building the PicoBlade bus[​](#building-the-picoblade-bus "Direct link to Building the PicoBlade bus")
...
### Radiomaster Nexus[​](#radiomaster-nexus "Direct link to Radiomaster Nexus")
...
#### 2. Remap SDA to LED\_STRIP[​](#2-remap-sda-to-led_strip "Direct link to 2. Remap SDA to LED_STRIP")
...
#### 3. Remap RPM-S to LED\_STRIP[​](#3-remap-rpm-s-to-led_strip "Direct link to 3. Remap RPM-S to LED_STRIP")
...
#### 4. Remap F.Port to LED\_STRIP[​](#4-remap-fport-to-led_strip "Direct link to 4. Remap F.Port to LED_STRIP")
...
### FrSky VANTAC RF007[​](#frsky-vantac-rf007 "Direct link to FrSky VANTAC RF007")
...
### Flywing HELI405[​](#flywing-heli405 "Direct link to Flywing HELI405")
