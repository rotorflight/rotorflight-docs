...
[FBus Master](https://www.youtube.com/embed/WHM7ZVK7rfk)
...
## Supported Sensors[​](#supported-sensors "Direct link to Supported Sensors")
...
## FBus Master Setup[​](#fbus-master-setup "Direct link to FBus Master Setup")

### Step 1 — Assign the UART[​](#step-1--assign-the-uart "Direct link to Step 1 — Assign the UART")

In the **Ports** tab, set the desired UART function to **FBus Out**. Save and reboot.

### Step 2 — Wire the sensor[​](#step-2--wire-the-sensor "Direct link to Step 2 — Wire the sensor")
...
### Step 3 — Verify sensor discovery[​](#step-3--verify-sensor-discovery "Direct link to Step 3 — Verify sensor discovery")
...
### Step 4 — Confirm telemetry on the radio[​](#step-4--confirm-telemetry-on-the-radio "Direct link to Step 4 — Confirm telemetry on the radio")
...
### FBus Master Parameters[​](#fbus-master-parameters "Direct link to FBus Master Parameters")
...
#### Adjusting the discovery window[​](#adjusting-the-discovery-window "Direct link to Adjusting the discovery window")
...
#### Limiting forwarded sensors[​](#limiting-forwarded-sensors "Direct link to Limiting forwarded sensors")
...
## S.Port Master Setup[​](#sport-master-setup "Direct link to S.Port Master Setup")

### Step 1 — Assign the UART[​](#step-1--assign-the-uart-1 "Direct link to Step 1 — Assign the UART")

In the **Ports** tab, set the desired UART function to **S.PORT Master**. Save and reboot.

### Step 2 — Wire the sensor[​](#step-2--wire-the-sensor-1 "Direct link to Step 2 — Wire the sensor")
...
### Step 3 — Verify and confirm[​](#step-3--verify-and-confirm "Direct link to Step 3 — Verify and confirm")
...
### S.Port Master Parameters[​](#sport-master-parameters "Direct link to S.Port Master Parameters")
...
## Inspecting Discovered Sensors[​](#inspecting-discovered-sensors "Direct link to Inspecting Discovered Sensors")
