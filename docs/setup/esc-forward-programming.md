...
## Configure the Flight controller[​](#configure-the-flight-controller "Direct link to Configure the Flight controller")

### Set the UART[​](#set-the-uart "Direct link to Set the UART")
...
### One Wire Communication (half-duplex)[​](#one-wire-communication-half-duplex "Direct link to One Wire Communication (half-duplex)")
...
#### Option 1[​](#option-1 "Direct link to Option 1")
