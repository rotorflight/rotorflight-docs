...
<img src={restore1} alt="Step 1" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
* Click on ***\[Clear output window]***. This removes any previous commands so they are not captured in your backup.  
  ...
  <img src={restore2a} alt="Step 3" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

* Type the backup command (from step 2) in the window and click ***\[ENTER]***.
  <img src={restore2} alt="Step 3" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

### Step 4.

<img src={restore3} alt="Step 4" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
<img src={restore4} alt="Step 1" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
...
* Click on the ***\[Execute]*** from the pop up.
  <img src={restore5} alt="Step 2" style={{ maxWidth: '100%' , borderRadius: '10px'}} />

### Step 3.

<img src={restore6} alt="Step 2" style={{ maxWidth: '100%' , borderRadius: '10px'}} />
