...
Additionally you can use CH11-AUX6 and CH12-AUX7 to perform in flight parameter adjustment using adjustment functions from the [Adjustments Tab](../../../configurator/tabs/adjustments.mdx#adjustment-functions).
...
Consult [Rotorflight Adjustments](../../../configurator/tabs/adjustments.mdx) for more info on how to setup the above adjustments.
