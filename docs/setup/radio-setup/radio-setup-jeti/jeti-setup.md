...
![Wiring](/assets/images/rx-wiring-59eacf58256ad059d14559ad3ffb89a3.png)
...
![DeviceExplorer](/assets/images/rc-dv-explorer-9801775d40ca0bcc890f937289c6ce71.png)

### Select Receiver type[​](#select-receiver-type "Direct link to Select Receiver type")

Select the receiver

![SelectRX](/assets/images/rx-select-rx-0778cae6a8f6de0846374686d1c172c3.png)

### Set alternate pin[​](#set-alternate-pin "Direct link to Set alternate pin")

Select the alternative pin configuration

![AltPin](/assets/images/rx-alt-pin-c49cf86d4a463548cafbeb35641e6d6d.png)

### Select ExBus pin[​](#select-exbus-pin "Direct link to Select ExBus pin")

* Set the pin to use the ExBus protocol

![Protocol](/assets/images/rx-set-protocol-275b3d7abbc4d7251a957a5e5ae7812c.png)
...
![SerialRX](/assets/images/serialrx-113fab703935cbbcde93709cc3208d2a.png)

### Setup Receiver[​](#setup-receiver "Direct link to Setup Receiver")

Then visit the receiver page and configure as follows

![ConfiguratorRXPage](/assets/images/receiver-9d664d1cd9b522493da76173942bec8a.png)
...
![ConfiguratorSensorsList](/assets/images/sensors-list-7cb2fe1f92e35d84ba916a835b0bb825.png)
