...
* Confirm and set the servo [center](/docs/configurator/tabs/servos.md#center) to your servo manufacturers recommendation. For Cyclic this will usually be 1520us, and for Tail it would be 760us.
...
* Confirm and set the servo [rate](/docs/configurator/tabs/servos.md#rate) as specified by your manufacturer. For many digital cyclic servos this is 333Hz and for most tail servos this is 560Hz.
...
* Confirm the servo arm travels **upwards** towards the swashplate. If not toggle the [servo reverse](/docs/configurator/tabs/servos.md#reverse).

Repeat with remaining cyclic servos.

[](/assets/medias/servo-setup-670e167379cd3f4a2bb24cb5ae342d49.mp4)
...
* Adjust [center](/docs/configurator/tabs/servos.md#center) to level the servo arm (0° or 90° depending on servo installation orientation). One quick way is to slide the override bar and copy the output value from the blue bar into the [center](/docs/configurator/tabs/servos.md#center) and press save. Make sure to reset the override to see the correct effect.
...
* measure the current servo arm angle and increase or decrease the [Scale Pos](/docs/configurator/tabs/servos.md#scale-neg-and-scale-pos) until the servo arm angle matches the override angle.
