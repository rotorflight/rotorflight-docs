...
## Governor Mode[​](#governor-mode "Direct link to Governor Mode")
...
### PASSTHROUGH[​](#passthrough "Direct link to PASSTHROUGH")
...
### Handover throttle[​](#handover-throttle "Direct link to Handover throttle")
...
startup time is applied before the RPM is detected. Some ESCs require really slow startup ramp to be gentle. Some other ESCs need really rapid start for starting at all.

### Spoolup time[​](#spoolup-time "Direct link to Spoolup time")
...
### Tracking time[​](#tracking-time "Direct link to Tracking time")
...
### Recovery time[​](#recovery-time "Direct link to Recovery time")
...
### Autorotation bailout time[​](#autorotation-bailout-time "Direct link to Autorotation bailout time")
...
### Autorotation timeout[​](#autorotation-timeout "Direct link to Autorotation timeout")
...
### Autorotation minimum entry time[​](#autorotation-minimum-entry-time "Direct link to Autorotation minimum entry time")

Minimum flight time before Autorotation can be engaged.

### Zero Throttle Timeout[​](#zero-throttle-timeout "Direct link to Zero Throttle Timeout")
...
The purpose of this feature is to allow fast spoolup in case the throttle cut (hold) is hit accidentally. If high throttle is returned very soon after, the heli will spool up quickly and hopefully keep on flying. Unit is 0.1s. Typical value is 5..50.

### Headspeed Signal Timeout[​](#headspeed-signal-timeout "Direct link to Headspeed Signal Timeout")
...
### Headspeed Filter Cutoff \[Hz][​](#headspeed-filter-cutoff-hz "Direct link to Headspeed Filter Cutoff \[Hz]")
...
### Battery Voltage Filter Cutoff \[Hz][​](#battery-voltage-filter-cutoff-hz "Direct link to Battery Voltage Filter Cutoff \[Hz]")
...
### TTA Bandwidth \[Hz][​](#tta-bandwidth-hz "Direct link to TTA Bandwidth \[Hz]")

Cutoff for the TTA (Torque Tail Assist) lowpass filter.

### Precomp Bandwidth \[Hz][​](#precomp-bandwidth-hz "Direct link to Precomp Bandwidth \[Hz]")

Cutoff for the cyclic/collective precompensation lowpass filter.

## Governor Profiles Settings[​](#governor-profiles-settings "Direct link to Governor Profiles Settings")
...
### Maximum Throttle[​](#maximum-throttle "Direct link to Maximum Throttle")

Maximum output throttle the governor is allowed to use.

### PID Master Gain[​](#pid-master-gain "Direct link to PID Master Gain")

Master gain multiplier

### P-Gain[​](#p-gain "Direct link to P-Gain")

Governor Proportional gain

### I-Gain[​](#i-gain "Direct link to I-Gain")

Governor Integral gain

### D-Gain[​](#d-gain "Direct link to D-Gain")

Governor Derivative gain

### Feedforward-Gain[​](#feedforward-gain "Direct link to Feedforward-Gain")

Governor Feedforward gain

### Yaw precompensation[​](#yaw-precompensation "Direct link to Yaw precompensation")
...
### Cyclic precompensation[​](#cyclic-precompensation "Direct link to Cyclic precompensation")
...
### Collective precompensation[​](#collective-precompensation "Direct link to Collective precompensation")
...
## Governor throttle input ranges[​](#governor-throttle-input-ranges "Direct link to Governor throttle input ranges")
...
### THROTTLE < *0%*[​](#throttle--0 "Direct link to throttle--0")
...
### *0%* < THROTTLE < *5%*[​](#0--throttle--5 "Direct link to 0--throttle--5")
...
### *5%* < THROTTLE < *Handover throttle%*[​](#5--throttle--handover-throttle "Direct link to 5--throttle--handover-throttle")
...
### *Handover throttle%* < THROTTLE < *100%*[​](#handover-throttle--throttle--100 "Direct link to handover-throttle--throttle--100")

In this range, the governor is in active state, and the requested rpm is *Handover throttle%..100%* of the gov\_headspeed.

## Governor State[​](#governor-state "Direct link to Governor State")
