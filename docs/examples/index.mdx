...
3. [Calibrate the Accelerometer](../configurator/tabs/setup.mdx#calibrate-accelerometer).
4. Check you [Board alignment](../configurator/tabs/configuration.mdx#board-and-sensor-alignment) setting and adjust if necessary.
...
7. Select [ESC Throttle protocol](../configurator/tabs/motors.mdx#esc-throttle-protocol), and Optional: [ESC Telemetry protocol](../configurator/tabs/motors.mdx#esc-telemetry-protocol), Set [Gear Ratios](../configurator/tabs/motors.mdx#gear-ratio-configuration), and [Motor Pole Count](../configurator/tabs/motors.mdx#motor-pole-count).
...
13. Set the [PID](../configurator/tabs/profiles.mdx#pid-controller-gains) Values.
14. Setup [ARMING](../configurator/tabs/modes.mdx#arm), and other required modes.
15. Setup [Profile Switching](../setup/profile-switching-example.mdx) and other [Adjustments](../configurator/tabs/adjustments.mdx) if required.
16. Setup [BLACKBOX](../configurator/tabs/blackbox.mdx#what-is-blackbox) Logging.
