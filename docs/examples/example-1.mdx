...
import example12 from "./img/example-1-2.png";
import example13 from "./img/example-1-3.png";
import example14 from "./img/example-1-4.png";
import example16 from "./img/example-1-6.png";
import example17 from "./img/example-1-7.png";
import example18 from "./img/example-1-8.png";
import ccpm from "../configurator/img/ccpm.svg";
import example19 from "./img/example-1-9.png";
import example110 from "./img/example-1-10.png";
import example111 from "./img/example-1-11.png";
import example114 from "./img/example-1-14.png";
import example112 from "./img/example-1-12.png";
import example113 from "./img/example-1-13.png";
...
<img src={example12} alt="Example 1" style={{ maxWidth: '100%', borderRadius: '10px' }} />
...
Open the [configuration tab](../configurator/tabs/configuration.mdx) and set the serial port **Port (A)** to **Serial\_RX**.\
**Save and Reboot**.

<img src={example13} alt="Example 1" style={{ maxWidth: '100%', borderRadius: '10px' }} />
...
<img src={example14} alt="Example 1" style={{ maxWidth: '100%', borderRadius: '10px' }} />
...
<img src={example16} alt="Example 1" style={{ maxWidth: '100%', borderRadius: '10px' }} />
...
Check and confirm on the [configuration tab](../configurator/tabs/configuration.mdx) that while moving your helicopter (gyro installed) that the model in the configurator moves in the same direction.

<img src={example17} alt="Example 1" style={{ maxWidth: '100%', borderRadius: '10px' }} />

### Gyro - Calibrate accelerometer

With the flight controller installed in your Helicopter open the [setup tab](../configurator/tabs/setup.mdx) and click on the [calibrate accelerometer](../configurator/tabs/setup.mdx#calibrate-accelerometer)

<img src={example18} alt="Example 1" style={{ maxWidth: '100%', borderRadius: '10px' }} />
...
<img src={ccpm} alt="Example 1" style={{ maxWidth: '100%', borderRadius: '10px' }} />
...
**RPM Sensor** - The nexus has an RPM input. The Yellow RPM signal wire from the ESC is plugged into this port. Enabling this toggle enables the RPM so it can be used for the [**Governor**](../configurator/tabs/governor.mdx) and [**RPM Filtering**](../setup/rpm-filters.mdx)\
...
:::info[note]
If your helicopter has a two stage gear train, please [**follow this guide**](../setup/two-stage-gear-train-ratios.mdx)
:::

<img src={example19} alt="Example 1" style={{ maxWidth: '100%', borderRadius: '10px' }} />

**Governor Mode** - Set this to "Mode 1". This will control the Headspeed and provide slow spoolup.\
See the [**Governor setup**](../configurator/tabs/governor.mdx) for details and examples.

<img src={example110} alt="Example 1" style={{ maxWidth: '100%', borderRadius: '10px' }} />
...
<img src={example111} alt="Example 1" style={{ maxWidth: '100%', borderRadius: '10px' }} />

## Power setup

Since we now have ESC telemetry working we can enable ESC Telemetry as the Voltage and current source.\\

<img src={example114} alt="Example 1" style={{ maxWidth: '100%', borderRadius: '10px' }} />
...
<img src={example112} alt="Example 1" style={{ maxWidth: '100%', borderRadius: '10px' }} />

## Rates

Review and modify your Rates to taste.

<img src={example113} alt="Example 1" style={{ maxWidth: '100%', borderRadius: '10px' }} />
