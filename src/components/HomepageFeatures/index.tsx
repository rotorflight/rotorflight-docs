...
const FeatureList = [
  {
    ...
    description: <>Governor with precompensation</>,
  },
  {
    title: "Advanced Filtering",
    Svg: require("@site/static/img/advanced-filtering.svg").default,
    description: <>Identify and filter</>,
  },
  {
  ...
  },
  {
    ...
    description: <>Rescue mode to auto level and gain altitude</>,
  },
  {
    title: "Motorised tail support",
    Svg: require("@site/static/img/motorised.svg").default,
    description: <>Motorised tail support with TTA</>,
  },
  {
    title: "ESC Telemetry",
    Svg: require("@site/static/img/esc-telemetry.svg").default,
    description: <>Read telemetry data from a wide range of ESCs</>,
  },
];
