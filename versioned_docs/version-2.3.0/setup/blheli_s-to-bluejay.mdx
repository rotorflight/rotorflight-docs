...
---
import bluejaySettings from "./img/Bluejay_settings.png";
import bluejayConnect from "./img/Bluejay_Connect.png";
import bluejaySelectFlash from "./img/Bluejay_Select_flash.png";
import bluejayLoadFirmware from "./img/Bluejay_Load_Firmware.png";
import bluejayComplete from "./img/Bluejay_Complete.png";
...
<img src={bluejaySettings} alt="Settings" style={{ maxWidth: '100%' }} />

### step 2.

From the top right corner click on **\[Connect]**. Power up the ESC with the flight pack and click on **\[Read Setup]**.

<img src={bluejayConnect} alt="Connect" style={{ maxWidth: '100%' }} />

### step 3.

Click on **\[Flash all]**
<img src={bluejaySelectFlash} alt="Select flash" style={{ maxWidth: '100%' }} />
...
<img src={bluejayLoadFirmware} alt="Load Firmware" style={{ maxWidth: '100%' }} />
...
<img src={bluejayComplete} alt="Connect" style={{ maxWidth: '100%' }} />
