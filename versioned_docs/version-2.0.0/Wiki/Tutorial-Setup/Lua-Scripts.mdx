...
<Tabs groupId="operating-systems">
  ...
  <TabItem value="ETHOS" label="ETHOS">
    ...
    IMPORTANT: Changes will only be written to the eeprom when the aircraft is moved from Armed to Disarmed, if you disconnect power when in an Armed state the changes will not be saved to eeprom.
